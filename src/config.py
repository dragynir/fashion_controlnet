...
training_config = TrainingConfig(
    ...
    scale_lr=True,
    validation_image=['./data/validation/test2.png'],
    validation_prompt=['a man in a suit holding a microphone on stage with a blue background behind him and a blue star pattern, Derek Hill, award, a bronze sculpture, american romanticism'],
