...
from config import training_config, current_dataset
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=training_config.pretrained_vae_model_name_or_path,
    ...
    parser.add_argument(
        ...
        type=int,
        default=training_config.checkpoints_total_limit,
    ...
    parser.add_argument(
        ...
        default=training_config.gradient_checkpointing,
        action="store_true",
    ...
    parser.add_argument(
        "--use_8bit_adam",
        action="store_true",
        default=training_config.use_8bit_adam,
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=training_config.enable_xformers_memory_efficient_attention,
...
def main(args):
    ...
    # Generate dataset
    train_dataset = current_dataset.generate_dataset()
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if args.validation_prompt is not None and global_step % args.validation_steps == 0:
                        print('Skipping validation due to out of memory!')
